...
import { topInstructors } from '../lib/data'
        ...
        <section className="padding-x padding-y">
            ...
            <div className="flex w-full">
                {topInstructors.map((instructor, index) => (
                    <div key={index} className="flex flex-col items-center w-[33%] mr-3">
                        <div className='mr-3 p-4 w-full' >
                            <Image
                        ...
                        <div className='flex my-4 justify-center'>
                            <Link href={instructor.facebookUrl} className='mr-4 cursor-pointer bg-[#0A6A56] p-2 rounded-full flex items-center justify-center '>
                            ...
                            <Link href={instructor.twitterUrl} className='mr-4 cursor-pointer bg-[#0A6A56] p-2 rounded-full'>
                                <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 0 512 512">
                            ...
                            <Link href={instructor.instagramUrl} className='cursor-pointer bg-[#0A6A56] p-2 rounded-full'>
