...
const Support = () => {
  return (
    <section className='padding-x flex-between md:flex-row flex-col py-14 overflow-hidden'>
        ...
        Our <b>Instructor Support Team</b> is here to answer your questions and review your test video, while our Teaching Center gives you plenty of resources to help you through the process. Plus, get the support of experienced instructors in our <b>online community</b>.
        </p>
        <a className="lg:text-base md:text-[.78rem] sm:text-[0.9rem] text-[0.825rem] text-purple-700 font-bold underline" href="/">Need more details before you start? Learn more.</a>
        </div>
