                ...
                <div className="mt-20">
                    ...
                    <div className="mt-10">
                        <div className="mb-7 flex justify-start items-start">
                            <div className="border border-solid border-gray-500 p-2 rounded cursor-pointer"> <IoMdMail style={{ color: 'rgba(10, 55, 47, 1)'}} className="h-5 w-5"/></div>
                            <p className="font-normal ml-3 mt-1">support@skillbridge.com</p>
                        </div>
                        <div className="mb-7 flex justify-start items-start">
                           <div className="border border-solid border-gray-500 p-2 rounded cursor-pointer"> <FaPhoneAlt style={{ color: 'rgba(14, 151, 123, 1)'}} className="h-5 w-5" /></div>
                            <p className="font-normal ml-3 mt-1">+91 00000 00000</p>
                        </div>
                        <div className=" flex justify-start items-start">
                           <div className="border border-solid border-gray-500 p-2 rounded cursor-pointer"> <IoLocationSharp style={{ color: 'rgba(247, 144, 9, 1)'}} className="h-5 w-5"/></div>
