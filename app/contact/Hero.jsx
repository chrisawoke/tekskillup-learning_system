    ...
    <main>
      ...
      >
        <div className=" text-center text-white px:1 md:px-20">
          <h2 className="text-2xl font-inter font-bold mb-10 md:text-[40px] md:font-extrabold">Contact Us</h2>
          <p className="text-md font-inter font-light md:text-[20px]">
            ...
            hear from you, your satisfaction is our priority. Send us message
