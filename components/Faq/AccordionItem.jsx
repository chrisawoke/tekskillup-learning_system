    ...
    return (
        <div>
            <div
                ...
                onClick={toggle}>
                <h3 className='text-[#262626] lg:text-[20px] xs:text-[14px] font-[600] leading-[30px] font-inter lg:w-[975px] xs:w-[300px]'>{question}</h3>
            ...
            <Collapse isOpened={open}>
                <div className='bg-white lg:px-[50px] xs:px-[10px] pb-[20px] text-[#4C4C4D] lg:text-[18px] xs:text-[14px] font-[400] leading-[27px] font-inter'>{answer}</div>
            </Collapse>
        </div>
    )
};
