...
const Faq = () => {
    ...
    return (
<<<<<<< HEAD
        <div className='xs:px-[0.75rem] lg:px-[10rem] w-[100vw] lg:ms-[-2rem] xs:ms-[-1rem]'>
            <div style={{ background: `rgba(10, 106, 86, 0.03)`, borderRadius: '10px', }} className='mt-[7rem] lg:w-[1100px] xs:w-[104%] lg:p-[80px] xs:py-[15px] px-[5px]'>
=======
        <div className='px-8 md:px-24 w-full'>
            <div style={{ background: `rgba(10, 106, 86, 0.03)`, borderRadius: '10px', }} className='mt-[5rem] xs:w-[100%] lg:p-[80px] xs:py-[15px] px-8'>
>>>>>>> upstream/main
